...
var _jsxFileName = "/Users/shreyans.jain/Apps/quip-apps/map/src/root.jsx";

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _quip = __webpack_require__(125);
...
var MapRoot = function (_quip$apps$RootRecord) {
  _inherits(MapRoot, _quip$apps$RootRecord);

  function MapRoot() {
    _classCallCheck(this, MapRoot);

    return _possibleConstructorReturn(this, (MapRoot.__proto__ || Object.getPrototypeOf(MapRoot)).apply(this, arguments));
  }

  _createClass(MapRoot, null, [{
    key: "getProperties",
...
_quip2.default.apps.registerClass(MapRoot, "root");

_quip2.default.apps.initialize({
  initializationCallback: function initializationCallback(rootNode, params) {
...
var _jsxFileName = "/Users/shreyans.jain/Apps/quip-apps/map/src/App.jsx";
...
*/
var GOOGLE_MAPS_API_KEY = "AIzaSyBEShAQpZOe0GRLir0PEmWYjATm7kdUmFc";

var GOOGLE_MAPS_URL = "https://www.google.com/maps/embed/v1/place?key=";
var INPUT_PLACEHOLDER = "Enter an address to map";
var SUBMIT_BTN_TXT = "Add Map";

var getRootRecord = _quip2.default.apps.getRootRecord;
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.handleSubmit = function (e) {
      var enteredAddress = _this.refs["text"].value;
  ...
  _createClass(App, [{
    ...
    value: function render() {
      var mapUrl = "" + GOOGLE_MAPS_URL + GOOGLE_MAPS_API_KEY + "&q=" + this.state.address;
      return React.createElement(
        "div",
        { className: _App2.default.container, __source: {
            fileName: _jsxFileName,
            lineNumber: 36
          },
          __self: this
        ...
        */
        !this.state.address && React.createElement(
          ...
          React.createElement("input", {
            className: _App2.default.address,
            ref: "text", type: "text",
            placeholder: INPUT_PLACEHOLDER, __source: {
              fileName: _jsxFileName,
              lineNumber: 44
            },
            __self: this
          ...
          React.createElement(
            "button",
            {
              className: _App2.default.submit,
        ...
        */
        this.state.address && React.createElement("iframe", {
          className: _App2.default.noborder,
          width: "600",
          height: "450",
          frameborder: "0",
          src: mapUrl, __source: {
...
module.exports = {"noborder":"App__noborder","address":"App__address","submit":"App__submit"};
